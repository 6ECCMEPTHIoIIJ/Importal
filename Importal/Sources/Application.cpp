...
namespace Importal
{
  std::string vertexShaderString = ShaderReader::ParseFile("Shaders\\VertexShader.glsl");
  const GLchar* vertexShaderSource = vertexShaderString.c_str();

  std::string fragmentShaderString = ShaderReader::ParseFile("Shaders\\FragmentShader.glsl");
  ...
  void Application::Run()
  {
    ...
    GLFWwindow* window = glfwCreateWindow(200, 300, "Importal", nullptr, nullptr);
